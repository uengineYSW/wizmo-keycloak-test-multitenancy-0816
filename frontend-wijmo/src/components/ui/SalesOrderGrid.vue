<template>
    <div style="max-height:80vh;">
        <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn @click="updateSalesOrder" small color="primary" :disabled="!hasRole('SalePerson')">
                    <v-icon small>mdi-minus-circle-outline</v-icon>UpdateSalesOrder
                </v-btn>
                <v-btn @click="deleteSelectedRows" small color="primary" :disabled="!hasRole('SalePerson')">
